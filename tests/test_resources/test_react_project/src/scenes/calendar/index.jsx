...
const Calendar = () => {
    ...
    return (
        <Box m='20px'>
            ...
            <Header title='CALENDAR' subtitle='Schedule your meetings'/>
            <Box display='flex' justifyContent='space-between'>
                ...
                <Box flex='1 1 100%' ml='15px'>
                    <FullCalendar 
                        ...
                        initialEvents={[{id: '1234', title: 'All-day event', date: '2022-09-14'}, {id: '1234', title: 'Timed event', date: '2022-09-28'}]}
                    />
                </Box>
            </Box>
        </Box>
